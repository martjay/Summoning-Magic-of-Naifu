...
1. Naifu本就是官方版本，性能与质量保证本身就是其他框架所不能比的，但新版的Web-UI也能跟官方版媲美我也没有话说。
2. 界面简洁舒适，没有复杂的参数设置，对于新手来说很友好，如果你是大佬那就另当别论了。
3. 没有Web-UI那么多语法，同样对新手友好。但也不能说Web-UI就不好，因为更复杂的语法代表了更多的可能性与更高的灵活度，也算是Web-UI的一个优点。
4. 现在关于Web-UI的教程数不胜数，而Naifu的教程却寥寥无几，想给走Naifu道路的同志留下一个路标。
